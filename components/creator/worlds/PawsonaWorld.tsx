...
export function PawsonaWorld({ world }: { world: CreatorWorld }) {
  return (
    <section
      id={`creator-world-${world.slug}`}
      className="creator-world creator-world--sealed creator-world--pawsona"
    ...
    >
      <div className="creator-sealed-portal creator-sealed-portal--pawsona">
        <CreatorVeil world={world} variant="cluster" />
